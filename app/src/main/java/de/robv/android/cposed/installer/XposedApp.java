...
import de.robv.android.cposed.installer.util.AssetUtil;
import de.robv.android.cposed.installer.util.DownloadsUtil;
import de.robv.android.cposed.installer.util.InstallZipUtil;
import de.robv.android.cposed.installer.util.InstallZipUtil.XposedProp;
import de.robv.android.cposed.installer.util.NotificationUtil;
...
public class XposedApp extends Application implements ActivityLifecycleCallbacks {
    ...
    private static final String BASE_DIR_LEGACY = "/data/data/de.robv.android.cposed.installer/";

    public static final String BASE_DIR = Build.VERSION.SDK_INT >= 24
            ? "/data/user_de/0/de.robv.android.cposed.installer/" : BASE_DIR_LEGACY;
    ...
    private static final String[] XPOSED_PROP_FILES = new String[]{
            "/su/xposed/cposed.prop", // official systemless
            "/system/cposed.prop",    // classical
    };
    ...
    public static void installApk(Context context, DownloadsUtil.DownloadInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            uri = FileProvider.getUriForFile(context, "de.robv.android.cposed.installer.fileprovider", new File(info.localFilename));
